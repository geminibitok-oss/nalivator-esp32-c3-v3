...
class encMinim
{
  ...
  private:
    ...
    uint8_t _state, _lastState, _encState, _countClick, pos;
    uint32_t _debTimer;
    bool _resetFlag = false;
    // 0 - ничего, 1 - лево, 2 - право, 5 - одиночный клик ,  6 - удержание,  7 - двойной клик, 8 - тройной клик
};
